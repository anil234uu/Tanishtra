...
export function MainHeaderClient({ headerNav, mobileNav }: { headerNav: NavLink[], mobileNav: NavLink[] }) {
            ...
            >
                <div className="w-full h-full px-[16px] md:px-[40px] flex items-center justify-between">
                    ...
                    <nav className="hidden md:flex items-center gap-[32px]">
                        {headerNav.map(link => (
                            <Link key={link.id} href={link.url} className="font-montserrat text-[13px] uppercase tracking-[2px] text-[#A1A1AA] hover:text-[#C6A75E] text-decoration-none transition-colors relative group">
                                {link.label}
